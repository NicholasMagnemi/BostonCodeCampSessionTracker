namespace SemesterProjectTest
{
    partial class ConferenceInformationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabSpeakerInfo = new TabPage();
            button3 = new Button();
            btnRemoveSpeaker = new Button();
            btnSaveSpeaker = new Button();
            btnNewSpeaker = new Button();
            ...
            txtBoxDayOfContact = new TextBox();
            ...
            lblSpeakerForm = new Label();
            tabRoomInfo = new TabPage();
            button1 = new Button();
            ...
            lblRoomForm = new Label();
            tabTimeSlotInfo = new TabPage();
            button2 = new Button();
            ...
            cmbSessionEndTime = new ComboBox();
            cmbSessionStartTime = new ComboBox();
            ...
            lblTimeSlotSession = new Label();
            txtBoxDurationOfSession = new TextBox();
            lblDurationSession = new Label();
            lblRoomName = new Label();
            cmbBoxRoomName = new ComboBox();
            cmbBoxSpeakerName = new ComboBox();
            lblSpeakerName = new Label();
            lblSessionName = new Label();
            lblSessionForm = new Label();
            tabOverview = new TabPage();
            button4 = new Button();
            btnNewSessionOverview = new Button();
            btnNewSpeakerOverview = new Button();
            txtBoxRoomOverview = new TextBox();
            lblRoomOverview = new Label();
            txtBoxDurationOverview = new TextBox();
            lblDurationOverview = new Label();
        ...
        private TabPage tabSpeakerInfo;
        private TabPage tabRoomInfo;
        private TabPage tabTimeSlotInfo;
        private TabPage tabSessionInfo;
        private TabPage tabOverview;
        private Label lblFirstName;
        private Label lblSpeakerForm;
        private Label lblEmail;
        private TextBox txtBoxEmail;
        private Label lblDayOfContact;
        private TextBox txtBoxDayOfContact;
        ...
        private Button btnSaveSpeaker;
        private Button btnNewSpeaker;
        private Label lblRoomForm;
        ...
        private Label lblTimeSlotSession;
        private TextBox txtBoxDurationOfSession;
        private Label lblDurationSession;
        private Label lblRoomName;
        private ComboBox cmbBoxRoomName;
        private ComboBox cmbBoxSpeakerName;
        private Label lblSpeakerName;
        private TextBox txtBoxRoomOverview;
        private Label lblRoomOverview;
        private TextBox txtBoxDurationOverview;
        private Label lblDurationOverview;
        ...
        private Button btnNewSessionOverview;
        private Button btnNewSpeakerOverview;
